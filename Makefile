...
SRC	=	main.c	\
		...
		src/handle/handle_pipe.c	\
		src/handle/handle_redirection.c	\
		...
		src/utils/len_double_buf.c	\
		src/utils/split.c	\
		src/utils/add_spaces.c	\
		src/utils/my_execve.c	\
		src/utils/print_error.c	\
		src/utils/trim.c	\
		src/utils/is_alpha.c	\
		src/utils/is_alphanum.c	\
		src/chained_list/add_node.c	\
		src/chained_list/create_node.c	\
		src/chained_list/chained_list_to_buf.c	\

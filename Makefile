...
SRC	=	src/shell/prompt.c \
		...
		src/shell/execs/alias_exp.c \
		src/shell/globbing/sh_exp.c \
		src/shell/globbing/glob_arg.c \
		src/shell/globbing/var_sub.c \
		src/shell/globbing/quote_rem.c \
		src/shell/globbing/cmd_sub.c \
		src/shell/globbing/exp_cmd.c \

...
SRC	=	main.c	\
		...
		src/utils/queue/is_empty.c \
		src/utils/queue/pop.c \
		src/utils/queue/push.c \
		src/algorithm/bfs.c \
		src/algorithm/construct_path.c \
		src/utils/dyna_array/append.c \
		src/utils/dyna_array/resize.c \
		src/algorithm/traverse_maze.c \
		src/free/free_maze.c \

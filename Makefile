...
SRC =	src/create.c	\
		...
		src/utils/free_sprite_node.c	\
		src/utils/my_str_to_word_array.c	\
		src/utils/free_array.c	\
		src/utils/collision.c	\
		src/utils/is_nbr.c	\
		src/utils/seconds_to_time.c	\
		config/get_plane_config.c	\
		src/objets/background.c	\
		src/objets/plane_tower.c	\
		src/objets/plane.c	\
		src/objets/window.c	\
		src/objets/clock.c	\
		src/objets/time.c	\
		src/quadtree/create_quadtree.c	\
		src/quadtree/destroy_quadtree.c	\
		src/quadtree/get_index.c	\
		src/quadtree/get_planes_in_area.c	\
		src/quadtree/insert.c	\
		src/quadtree/split.c	\

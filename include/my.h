...
*/
    ...
    #define PLANE_SCALE 0.1
    #define TOWER_SCALE 0.1
    #define CAPACITY 4
    #define QT_NODE_CAPACITY 1024
...
typedef struct quadtree_s {
    sfFloatRect zone;
    sprite_list_t *plane[QT_NODE_CAPACITY];
    int nbr_plane;
    struct quadtree_s *children[4];
    bool divided;
} quadtree_t;

typedef struct time_text_s
{
    sfText *text;
    sfFont *font;
} time_text_t;

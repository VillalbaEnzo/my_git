...
*/
    ...
    #define GRASS_TEXT "assets/textures/grass.png"
    #define STONE_TEXT "assets/textures/stone.png"
    #define SNOW_TEXT "assets/textures/snow.png"
    #define DIRT_TEXT "assets/textures/dirt.png"
    #define SECRET_TEXT "assets/textures/secret.png"
...
typedef struct {
    ...
    sfTexture *stone_text;
    sfTexture *secret_text;
} texture_t;

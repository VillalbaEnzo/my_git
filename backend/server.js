...
// 1. Inscription (Pour créer tes comptes de test)
...
// 3. USER : Infos & Génération QR
app.get('/api/user/me', auth, async (req, res) => {
    // Génère un nouveau token QR à chaque affichage pour la sécurité
...
app.post('/api/admin/scan', auth, async (req, res) => {
    ...
    user.balance -= 1;
    user.qrToken = null; // On invalide le QR
